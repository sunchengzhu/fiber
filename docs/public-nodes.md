...
Since public nodes contribute 0 UDT when auto-accepting channel openings, UDT payments use the path nodeA → node1 → node2 (generating invoices on node2's public RPC). Only nodeA is needed for this section.
